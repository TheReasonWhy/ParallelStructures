#-------------------------------------------------
#
# Project created by QtCreator 2019-07-24T04:53:41
#
#-------------------------------------------------

QT       -= gui

TARGET = statistics_manager
TEMPLATE = lib
CONFIG += staticlib
...
HEADERS += \
    statistics_manager_local.hpp \
    statistics_manager_global.hpp \
    statistics_chunk.hpp \
    statistics_manager_middle.hpp
unix {
    target.path = /usr/lib
    INSTALLS += target
}
