#ifndef PARALLEL_STACK_PACKAGED_HPP
#define PARALLEL_STACK_PACKAGED_HPP
...
template<typename T>
class parallel_stack_packaged : public Parallel_container<T, parallel_stack_packaged>
{
public:
...
void increase_head_count(CNPS& old_counter){
    ...
    parallel_stack_packaged(parallel_stack_packaged &other):m_head(other.m_head)
    {

    }
    parallel_stack_packaged(parallel_stack_packaged const &other):m_head(other.m_head.load())
    {

    }

    parallel_stack_packaged& operator = (parallel_stack_packaged &other)
    {
...
#endif // PARALLEL_STACK_PACKAGED_HPP
