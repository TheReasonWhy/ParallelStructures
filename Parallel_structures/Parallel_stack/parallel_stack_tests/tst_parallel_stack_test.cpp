...
class parallel_stack_test : public QObject
{
    Q_OBJECT
...
private slots:
    void P_stack_test_data();
    void P_stack_test();

};

parallel_stack_test::parallel_stack_test()
{
...
void parallel_stack_test::P_stack_test_data()
{
...
void parallel_stack_test::P_stack_test()
{
...
QTEST_APPLESS_MAIN(parallel_stack_test)

#include "tst_parallel_stack_test.moc"
