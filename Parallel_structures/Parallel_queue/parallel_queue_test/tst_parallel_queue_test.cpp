...
class parallel_queue_test : public QObject
{
    Q_OBJECT
...
private slots:
    void P_queue_test_data();
    void P_queue_test();

};

parallel_queue_test::parallel_queue_test()
{
...
void parallel_queue_test::P_queue_test_data()
{
...
void parallel_queue_test::P_queue_test()
{
...
QTEST_APPLESS_MAIN(parallel_queue_test)

#include "tst_parallel_queue_test.moc"
