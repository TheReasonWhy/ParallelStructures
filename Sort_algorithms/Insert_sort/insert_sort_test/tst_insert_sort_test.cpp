...
class insert_sort_test : public QObject
{
    Q_OBJECT
...
insert_sort_test::insert_sort_test()
{
...
void insert_sort_test::initTestCase()
{

}

void insert_sort_test::cleanupTestCase()
{

}

void insert_sort_test::test_case1_data()
{
...
void insert_sort_test::test_case1()
{
    ...
    std::vector<unsigned> test_vec = {input1,input2,input3,input4,input5,input6,
                                          ...
                                          input13,input14};
    Insert_sort<unsigned>::sort(test_vec);
...
QTEST_APPLESS_MAIN(insert_sort_test)

#include "tst_insert_sort_test.moc"
